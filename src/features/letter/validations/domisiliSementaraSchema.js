...
export const domisiliSementaraSchema = {
  domisili: yup.object().shape({
    ...
    address_original: yup.string().required("Alamat asal wajib diisi"),
    address_now: yup.string().required("Alamat sekarang wajib diisi"),
  }),
};
